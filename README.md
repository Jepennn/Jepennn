...
![Tailwind](https://img.shields.io/badge/Tailwind-0A0A0A?logo=tailwindcss)
...
![Supabase](https://img.shields.io/badge/Supabase-0A0A0A?logo=supabase)
![Docker](https://img.shields.io/badge/Docker-0A0A0A?logo=docker)
![GCP](https://img.shields.io/badge/GCP-0A0A0A?logo=googlecloud)
